...
export const defaultNoTheme1 = () => <HtmlTable
  id="sid"
  columns={[{
    header: "Student Id",
    field: 'sid',
...
export const defaultNoTheme2 = () => <HtmlTable
  id="sid"
  columns={[{
    header: "Id",
    field: 'id',
...
export const darkTheme = () => <ThemeProvider theme={dark}>
  <HtmlTable
    id="sid"
    columns={[{
      header: "Id",
...
export const lightTheme = () => <ThemeProvider theme={light}>
  <HtmlTable
    id="sid"
    columns={[{
      header: "Id",
...
export const lightThemeNoPagination = () => <ThemeProvider theme={light}>
  <HtmlTable
    id="sid"
    columns={[{
      header: "Id",
...
export const customCell = () => <ThemeProvider theme={dark}>
  <HtmlTable
    id="sid"
    columns={[{
      header: "Id",
